  ...
  <body>
    ...
    <main>
      <section class="container">
        <?php
        include '../controller/Feed.php';
        foreach($posts as $post){ 
               echo "<div class='feed'>
               <h4>
                 <a href='../view/ViewPost.php?post_id=" . $post['post_id'] . "'>" . $post['Title'] . "
               </h4>
               <div><p>By <a href='../view/Profile.php?user_id=".$post['user_id']."'>". $post['fname'] ." " . $post['lname'] . "</a> on " . $post['post_date'] . "</p></div>
